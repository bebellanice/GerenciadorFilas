			...
			<tbody>
				...
				<tr id="tr_index_appcontainer">
					<td id="td_index_appcontainer" colspan="2">
							...
							<fieldset id="fieldset_registro_atendimento">
								...
								<table cellspacing="0" cellpading="0">
									...
									<c:forEach items="${clientesList }" var="cliente">
										<tr>
											...
											<td>
												<a target="_blank" href="./geraDecComparecimento?cliente_id=${cliente.id }">
													<button type="button">Gerar Declaração de Comparecimento</button>
												</a>
											</td>
										</tr>
									</c:forEach>
