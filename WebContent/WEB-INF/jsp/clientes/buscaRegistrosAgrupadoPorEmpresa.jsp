			...
			<tbody>
				...
				<tr id="tr_index_appcontainer">
					<td id="td_index_appcontainer" colspan="2">
						<form action="geraEmpresaReport" method="POST" class="form_input_data" target="_blank">
							<fieldset>

								<legend>Buscar registro de atendimento</legend>
	
								<label for="inicio">Selecione o período desejado:</label> 
								<input required="" type="text" name="inicio" class="data" id="inicio">
								<label for="fim"> a </label> 
								<input required="" type="text" name="fim" class="data" id="fim">
								<br/>
